...
const CompoundLong = artifacts.require("CompoundLong")

contract("CompoundLong", (accounts) => {
  ...
  let tokenBorrow
  beforeEach(async () => {
    testCompound = await CompoundLong.new(CETH, C_TOKEN_BORROW, TOKEN_BORROW, 18)
